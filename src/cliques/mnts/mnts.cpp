...
{
     int i, j, k, k1, l, m0, m, m1=0, n, n1, mm1, ti;
...
int isValidColoring(int* color) {
  ...
  for (int i=0; i<Max_Vtx; ++i) {
    for (int j=0; j<Max_Vtx; ++j) if (Edge[i][j] and color[i] == color[j]) return 0;
  }  
  return cols.size();
}
...
int main(int argc, char **argv)
{
      ...
      for( i = 0; i < 100; i++ )
      {
          ...
          if (l > best_l) {
            best_l = l;
            memcpy(best, TTbest, Max_Vtx*sizeof(int));            
          }
      }

      // cout << "isValidColoring(BC): " << isValidColoring(BC) << endl;
      // cout << "isValidColoring(C0): " << isValidColoring(C0) << endl;
      // cout << "isValidColoring(C1): " << isValidColoring(C1) << endl;
      // cout << "isValidColoring(TC1): " << isValidColoring(TC1) << endl;
      // cout << "isValidColoring(We): " << isValidColoring(We) << endl;      
      // cout << "isValidColoring(FC1): " << isValidColoring(FC1) << endl;
      // cout << "isValidColoring(Tbest): " << isValidColoring(Tbest) << endl;
      // cout << "isValidColoring(cruset): " << isValidColoring(cruset) << endl;
      // cout << "isValidColoring(vectex): " << isValidColoring(vectex) << endl;
      // cout << "isValidColoring(funch): " << isValidColoring(funch) << endl;
      // cout << "isValidColoring(address): " << isValidColoring(address) << endl;
      ...
      // cout << best_l << endl;
      for (int i=0; i<Max_Vtx; ++i) if (best[i]) cout << i << " ";
        cout << endl;
